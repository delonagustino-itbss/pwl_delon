...
<head>
    ...
    <title>Halaman Mahasiswa - Tambah Jurusan</title>
...
<div class="main-content">
    <div class="glass-card">
        ...
        <h1 class="glass-title">Tambah Jurusan</h1>

        <form action="{{ action([App\Http\Controllers\JurusanController::class, 'store']) }}" method="post">
            @csrf
            <table class="glass-table">
              <tr>
                <td>Nama Jurusan</td><td>:</td><td><input type="text" name="nama_jurusan" autocomplete="off" required></td>
              </tr>
              <tr>
                <td>Kode Jurusan</td><td>:</td><td><input type="text" name="kode_jurusan" autocomplete="off" required></td>
              </tr>
              <tr>
                <td></td><td></td>
                <td>
