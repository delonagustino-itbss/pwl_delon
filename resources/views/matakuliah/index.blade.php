...
<head>
    ...
    <title>Sistem Academic ITBSS - Data Mata Kuliah</title>
    ...
    <style>
        ...
        /* =======================================================
           EFEK TRANSPARANSI PREMIUM iOS WIDGET (MATA KULIAH)
           ======================================================= */
        .ios-table-container {
            display: flex;
            flex-direction: column;
        ...
        .ios-header-row {
            display: grid;
            grid-template-columns: 50px 1.5fr 1.8fr 3fr 1fr 1.5fr 2fr 1.8fr; /* Rasio grid 8 kolom data */
            gap: 10px;
            padding: 0 10px;
        }
        ...
        .ios-data-row {
            display: grid;
            grid-template-columns: 50px 1.5fr 1.8fr 3fr 1fr 1.5fr 2fr 1.8fr;
            gap: 10px; 
            align-items: stretch;
        }
        ...
        .ios-td {
            ...
            padding: 16px 12px;
            color: #000000 !important; /* Hitam pekat agar teks kontras dan terbaca jelas */
            font-size: 13.5px;
            font-weight: 500;
            display: flex;
            align-items: center;
    ...
    <div class="container-fluid px-5">
        <div class="glass-panel">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
                <h1 class="page-title mb-0">Table Mata Kuliah</h1>
            ...
            <div class="ios-table-container">
                ...
                <div class="ios-header-row">
                    ...
                    <div class="ios-th">Jurusan ID</div>
                    <div class="ios-th">Kode Mata Kuliah</div>
                    <div class="ios-th">Nama Mata Kuliah</div>
                    <div class="ios-th">SKS</div>
                    <div class="ios-th">Dosen ID</div>
                ...
                <div class="ios-data-row">
                    <div class="ios-td center fw-bold">{{ $mk->id }}</div>
                    <div class="ios-td center">{{ $mk->jurusan_id }}</div>
                    <div class="ios-td center fw-semibold">{{ $mk->kode_mk }}</div>
                    <div class="ios-td fw-semibold">{{ $mk->nama_mk }}</div>
                    <div class="ios-td center fw-bold">{{ $mk->sks }}</div>
                    <div class="ios-td center">{{ $mk->dosen_id }}</div>
                    <div class="ios-td center">{{ $mk->created_at }}</div>
                    <div class="ios-td center">
                        <div class="d-flex gap-2 justify-content-center w-100">
                            <a href="{{ action([App\Http\Controllers\MatakuliahController::class, 'edit'], [$mk->id]) }}" class="text-decoration-none">
                                <button type="button" class="btn btn-action-edit">Edit</button>
                            </a>
                            <form action="{{ action([App\Http\Controllers\MatakuliahController::class, 'destroy'], [$mk->id]) }}" method="post" class="m-0" onsubmit="return confirm('Hapus data mata kuliah ini?')">
                                @csrf
