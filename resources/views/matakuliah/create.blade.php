...
<head>
    ...
    <title>Halaman Mahasiswa - Tambah Mata Kuliah</title>
    ...
    <style>
        ...
        /* Kolom Input Text Bergaya Modern Minimalis */
...
<div class="main-content">
    <div class="glass-card">
        ...
        <h1 class="glass-title">Tambah Mata Kuliah</h1>

        <form action="{{ action([App\Http\Controllers\MatakuliahController::class, 'store']) }}" method="post">
            @csrf
            <table class="glass-table">
                <tr>
                    <td>Jurusan ID</td><td>:</td><td><input type="text" name="jurusan_id" autocomplete="off" required></td>
                </tr>
                <tr>
                    <td>Kode Mata Kuliah</td><td>:</td><td><input type="text" name="kode_mk" autocomplete="off" required></td>
                </tr>
                <tr>
                    <td>Nama Mata Kuliah</td><td>:</td><td><input type="text" name="nama_mk" autocomplete="off" required></td>
                </tr>
                <tr>
                    <td>SKS</td><td>:</td><td><input type="text" name="sks" autocomplete="off" required></td>
                </tr>
                <tr>
                    <td>Dosen ID</td><td>:</td><td><input type="text" name="dosen_id" autocomplete="off" required></td>
                </tr>
                <tr>
                    <td></td><td></td>
                    <td>
