...
<head>
    ...
    <title>Sistem Academic ITBSS - Data Mahasiswa</title>
    ...
    <style>
        ...
        /* Menu Dropdown Putih Terang (Light Glass) agar teks terbaca jelas */
        ...
        /* =======================================================
           EFEK TRANSPARANSI PREMIUM iOS WIDGET (MAHASISWA)
           ======================================================= */
        .ios-table-container {
            display: flex;
            flex-direction: column;
        ...
        .ios-header-row {
            display: grid;
            grid-template-columns: 50px 2.5fr 1.5fr 1.5fr 2.5fr 2.5fr 2fr 1.8fr; /* Distribusi responsif 8 kolom */
            gap: 10px;
            padding: 0 10px;
        }
        ...
        .ios-data-row {
            display: grid;
            grid-template-columns: 50px 2.5fr 1.5fr 1.5fr 2.5fr 2.5fr 2fr 1.8fr;
            gap: 10px; 
            align-items: stretch;
        }
        ...
        .ios-td {
            ...
            padding: 16px 12px;
            color: #000000 !important; /* Teks hitam pekat agar tajam menembus kaca */
            font-size: 13.5px;
            font-weight: 500;
            display: flex;
            align-items: center;
    ...
    <div class="container-fluid px-5">
        <div class="glass-panel">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
                <h1 class="page-title mb-0">Table Data Mahasiswa</h1>
            ...
            <div class="ios-table-container">
                ...
                <div class="ios-header-row">
                    ...
                    <div class="ios-th">NIM</div>
                    <div class="ios-th">NIDN</div>
                    <div class="ios-th">Tempat/Tanggal Lahir</div>
                ...
                <div class="ios-data-row">
                    <div class="ios-td center fw-bold">{{ $m->id }}</div>
                    <div class="ios-td fw-semibold">{{ $m->fullname }}</div>
                    <div class="ios-td center">{{ $m->NIM }}</div>
                    <div class="ios-td center">{{ $m->NIDN }}</div>
                    <div class="ios-td">{{ $m->tempat_lahir }}, {{ $m->tanggal_lahir }}</div>
                    <div class="ios-td">{{ $m->alamat }}</div>
                    <div class="ios-td center">{{ $m->created_at }}</div>
                    <div class="ios-td center">
                        <div class="d-flex gap-2 justify-content-center w-100">
                            <a href="{{ action([App\Http\Controllers\MahasiswaController::class, 'edit'], [$m->id]) }}" class="text-decoration-none">
                                <button type="button" class="btn btn-action-edit">Edit</button>
                            </a>
                            <form action="{{ action([App\Http\Controllers\MahasiswaController::class, 'destroy'], [$m->id]) }}" method="post" class="m-0" onsubmit="return confirm('Hapus data mahasiswa ini?')">
                                @csrf
